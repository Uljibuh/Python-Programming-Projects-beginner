...
# this is so that we can say "create a new board object", 
...
class Board:
    def __init__(self, dim_size, num_bombs):
        ...
        # initialize a set to keep trackn of which locations we uncovered
        # we save (row,col) tuples into this set
        self.dug = set()
    ...
    def __str__(self):
        ...
        # it print out this function return!
...
def play(dim_size=10, num_bombs=10):
    ...
    # step 3b: if location is not a bomb, dig recursively ultil each square is at least next to a bomb
